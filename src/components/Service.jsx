...
const Service = () => {
  return (
    <div id="services" className="max-w-[1160px] m-auto w-full px-3 pt-24 lg:pt-32 mt-[400px] lg:mt-0">
      <div className="grid grid-cols-10">
        <div className="col-span-10 w-full lg:col-span-5">
          <div><span className="border px-7 py-2 rounded-full text-[16px]">
            Service
          </span>
          <h2 className="text-[36px] w-[300px] font-bold my-5">
            We Help To Get Soultions
          </h2>
          <p className="text-[16px] lg:w-[350px]">
        ...
        <div className="col-span-10 mt-10 lg:mt-0 w-full lg:col-span-5 relative">
          ...
          <div className="absolute bottom-5 left-5 mr-5 px-[30px] py-[30px] rounded-3xl bg-[#121057]  text-white bg-opacity-70">
        ...
        <div className="col-span-10 w-full lg:col-span-5 relative mt-10">
          <div className="w-full h-full">
            <img
              className=""
